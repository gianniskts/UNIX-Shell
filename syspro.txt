...
-----------------------------History-----------------------------
Examples; 1) in-mysh-now:>history
	  2) in-mysh-now:>h2
	 
Implementation
Η διαχείρηση του ιστορικού γίνεται μέσω της συνάρτησης addHistory() η οποία προσθέτει κάθε εντολή του χρήστη στον πίνακα ιστορικού history[]. Μέσω της checkHistory() όταν ο χρήστης πληκτρολογήσει history μπορεί να δει το ιστορικό του και πληκτρολογώντας h{index} (πχ. h1) μπορεί να εκτελέσει την εντολή ιστορικού index.
